...
<SVML>
<BUTTON name="previous" x="20" y="420"
             width="100" height="20"
             align="center"
             class="BUTTON2"
             href="../home.jsp">HOME</BUTTON>
...
<TEXT name="text" x="420" y="70" align="center" class="TEXT1">TEAM TOURNAMENTS</TEXT>

    <RECTANGLE name="rect" x="215" y="90" width="410" height="2" zValue="200000.0"
             lineColor="#ffffcc00" fillColor="#ffffcc00"/>

    <BUTTON name="create" x="230" y="105" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="search"
        down="active"
        selectable="default"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_Create.jsp">Create Tournament</BUTTON>
            
    <BUTTON name="active" x="230" y="130" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="create"
        down="my"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_List.jsp">Active Tournaments</BUTTON>

    <BUTTON name="my" x="230" y="155" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="active"
        down="archived"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_MyTeamTourneysMenu.jsp">My Tournaments</BUTTON>

    <BUTTON name="archived" x="230" y="180" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="my"
        down="won"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_ArchiveList.jsp">Archived Tournaments</BUTTON>

    <BUTTON name="won" x="230" y="205" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="archived"
        down="rules"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_WonList.jsp">Tournaments I've Won</BUTTON>

    <BUTTON name="rules" x="230" y="230" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="won"
        down="search"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_Rules.jsp">Tournament Rules</BUTTON>

    <BUTTON name="search" x="230" y="255" width="225" height="20" fontSize="15"
        align="left"
        class="BUTTON1"
        up="rules"
        down="create"
        href="http://warhawk-prod3.svo.online.scea.com:10060/WARHAWK_SVML/teamtourney/TeamTourney_Search.jsp">Search Tournaments</BUTTON></SVML>
