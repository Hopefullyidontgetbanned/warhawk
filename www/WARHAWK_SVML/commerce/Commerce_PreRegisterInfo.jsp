...
<TEXT name="text" x="420" y="70" align="center" class="TEXT1">Register Information</TEXT>
    
    <RECTANGLE name="rect" x="215" y="90" width="410" height="2" zValue="200000.0"
        lineColor="#ffffcc00" fillColor="#ffffcc00"/>
             
    <TEXT name="text" x="245" y="150" align="left" fontSize="12" textColor="#ffffffff">card not being charged notification</TEXT>
    <TEXT name="text" x="245" y="250" align="left" fontSize="10" textColor="#ffffffff">enter valid email notification</TEXT>

    <TEXT name="help" x="390" y="418" align="center" fontSize="12"
        textColor="#ff00ffff">Press triangle to go back</TEXT>

    <BUTTON name="button1" x="240" y="330" width="100" height="20" fontSize="10" align="center"  class="BUTTON1" selectable="true" href="https://warhawk-prod3.svo.online.scea.com:10061/WARHAWK_SVML/commerce/Commerce_RegisterInfo.jsp">Proceed</BUTTON>
